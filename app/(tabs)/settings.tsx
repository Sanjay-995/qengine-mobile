...
function Row({ icon, label, value, toggle, toggleValue, onToggle, onPress, dangerous, valueColor }: RowProps) {
  ...
  return (
    ...
    >
      ...
      {toggle && onToggle !== undefined ? (
        ...
        <Text style={[styles.rowValue, { color: valueColor ?? colors.mutedForeground, fontFamily: "Inter_400Regular" }]}>
          {value}
        </Text>
      ) : onPress ? (
